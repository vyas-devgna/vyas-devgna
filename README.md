<!--
  GitHub Profile README — Devgna Vyas
  Visual overhaul only: all facts, projects, links, and claims are preserved
  from the original profile README.
...
### `01` — [ez-drop](https://github.com/vyas-devgna/ez-drop)
...
### `02` — [Tutoring](https://github.com/vyas-devgna/Tutoring)
...
### `03` — [Portfolio](https://github.com/vyas-devgna/Portfolio)
...
### `04` — [Same.Energy Android Client](https://github.com/vyas-devgna/same-energy-android)
...
<p align="center">
  ...
  &nbsp;&nbsp;&nbsp;
  <a href="https://vyasdevgna.online/tip"><img src="https://raw.githubusercontent.com/vyas-devgna/vyas-devgna/main/assets/upi-logo.png" alt="Tip via UPI" width="88" height="31"></a>
</p>
...
<sub><code>FIELD NOTE END · BUILD SMALL · SHIP CLEAN · UNDERSTAND THE SYSTEM</code></sub>
